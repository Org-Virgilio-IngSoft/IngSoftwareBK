...
public class ReleasesBK {
		...
		try (
			...
			BufferedWriter bw=new BufferedWriter(fw);
			 ...
			 while( (lineFileRead=br.readLine() ) !=null ) {
				 ...
				 cleanSplitNameVersion = HelpBK.getRidOfEmptyString(splitNameVersion);
	...
	public void findInjectedVersions(String pathFileWithKnownInjectedVersionsIndex) throws  IOException, SQLException {
	   ...
	   //execute query sql
	   String query="INSERT INTO \"TicketWithInjectedVersionBK\" (  \"TicketBugID\" , \"DateInjectedVersion\" , \"InjectedVersion\")  "+
					"VALUES ( ? , ? , ?)";
	...
	public void findFixVersionsOpenVersionsIndex(String pathFileWithFixVersionsOpenVersions) throws  IOException, ParseException, SQLException {
		...
		//execute sql query
		String query="INSERT INTO \"Ticket_FV_OV_P_IV_BK\" (  \"TicketBugID\" , \"FV\" , \"DateFixVersion\" , \"OV\" , \"DateOpenVersion\" )  "+
				"VALUES ( ? , ?, ?, ?, ? )";
